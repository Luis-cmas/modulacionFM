...
title('s(t)')
figure(31);
plot(f,fftshift(abs(fft(yfm_r,N)))*ts);
...
figure(9)
plot(t, theta1)
title('Recuperacion de la fase de yfm')
...
subplot(211);
plot(t,m_recphase);
title("derivada de fase");
subplot(212);
plot(t,fftshift(abs(fft(m_recphase)))*ts/kf);
title("espectro derivada de fase");
